...
class ASRTrainer(BaseTrainer):
    ...
    def _train_epoch(self, dataloader):
        ...
        for i, batch in enumerate(dataloader):
            ...
            if self.ctc_weight > 0:
                ...
                log_probs = ctc_inputs["log_probs"]#.transpose(0,1)#.log_softmax(2).transpose(0, 1)
    ...
    def _validate_epoch(self, dataloader):
        ...
        # TODO: Call recognize
        results = self.recognize(dataloader, recognition_config=None, config_name='validation', max_length=self.text_max_len)
    ...
    def train(self, train_dataloader, val_dataloader, epochs: int):
        ...
        #train_dataloader.to(self.device)
        #val_dataloader.to(self.device)
